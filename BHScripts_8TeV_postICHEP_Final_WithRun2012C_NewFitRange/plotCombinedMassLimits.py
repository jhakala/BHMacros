...
def main():
   ...
   for summary in config.summary_list:
      ...
      legend = TLegend(0.1304355,0.1694915,0.4505645,0.3733051) # for BM
      legend = TLegend(0.1304355,0.1294915,0.4505645,0.3733051) # for CH
      ...
      graphs.GetYaxis().SetTitleOffset(1.25)
      graphs.GetYaxis().SetTitleSize(0.037)
      graphs.GetYaxis().SetLabelSize(0.037)
      graphs.GetXaxis().SetTitleSize(0.037)
      graphs.GetXaxis().SetLabelSize(0.037)     
